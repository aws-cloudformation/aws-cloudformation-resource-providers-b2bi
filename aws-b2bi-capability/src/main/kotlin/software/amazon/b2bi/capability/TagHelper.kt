...
import software.amazon.b2bi.capability.Tag as ResourceTag

object TagHelper {
    private const val TAG_OPERATION = "AWS-B2BI-Capability::TagResource"
    private const val UNTAG_OPERATION = "AWS-B2BI-Capability::UntagResource"

    ...
    override fun handleRequest(
        ...
        return ProgressEvent.progress(
                ...
                .then { progress ->  // STEP 1.0 [initialize a proxy context]
                    ...
                    proxy.initiate(
                            "AWS-B2BI-Transformer::Update::PreUpdateCheck",
                            proxyClient,
                ...
                .then { progress ->  // STEP 2.0 [initialize a proxy context]
                    // Implement client invocation of the update request through the proxyClient, which is already initialised with
                    // caller credentials, correct region and retry settings
                    proxy.initiate(
                            "AWS-B2BI-Transformer::Update::first",
                            proxyClient,
                            progress.getResourceModel(),
                            progress.getCallbackContext()
                    ) // STEP 2.1 [TODO: construct a body of a request]
                            .translateToServiceRequest(Translator::translateToFirstUpdateRequest) // STEP 2.2 [TODO: make an api call]
                            .makeServiceCall { awsRequest, client ->
                                val awsResponse: AwsResponse? = null
                                try {
                ...
                .then { progress ->  // STEP 3.0 [initialize a proxy context]
                    ...
                    proxy.initiate(
                            "AWS-B2BI-Transformer::Update::second",
                            proxyClient,
                            progress.getResourceModel(),
                            progress.getCallbackContext()
                    ) // STEP 3.1 [TODO: construct a body of a request]
                            .translateToServiceRequest(Translator::translateToSecondUpdateRequest) // STEP 3.2 [TODO: make an api call]
                            .makeServiceCall { awsRequest, client ->
                                val awsResponse: AwsResponse? = null
                                try {

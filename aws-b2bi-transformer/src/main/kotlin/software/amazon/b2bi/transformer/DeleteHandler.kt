...
import software.amazon.cloudformation.proxy.CallChain.ExceptionPropagate
    ...
    override fun handleRequest(
        ...
        return ProgressEvent.progress(
                ...
                .then { progress ->  // STEP 1.0 [initialize a proxy context]
                    ...
                    proxy.initiate(
                            "AWS-B2BI-Transformer::Delete::PreDeletionCheck",
                            proxyClient,
                ...
                .then { progress ->  // If your service API throws 'ResourceNotFoundException' for delete requests then DeleteHandler can return just proxy.initiate construction
                    ...
                    proxy.initiate(
                            "AWS-B2BI-Transformer::Delete",
                            proxyClient,
                            progress.getResourceModel(),
                            progress.getCallbackContext()
                    ) // STEP 2.1 [TODO: construct a body of a request]
                            .translateToServiceRequest(Translator::translateToDeleteRequest) // STEP 2.2 [TODO: make an api call]
                            .makeServiceCall { awsRequest, client ->
                                val awsResponse: AwsResponse? = null
                                try {

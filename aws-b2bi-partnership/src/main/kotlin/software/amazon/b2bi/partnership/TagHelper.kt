...
class TagHelper {
    ...
    private fun tagResource(
        ...
        serviceClient: ProxyClient<B2BiClient>,
        resourceModel: ResourceModel,
        handlerRequest: ResourceHandlerRequest<ResourceModel>,
        ...
        return proxy.initiate("AWS-B2BI-Partnership::TagOps", serviceClient, resourceModel, callbackContext)
            .translateToServiceRequest { model: ResourceModel? -> Translator.tagResourceRequest(model, addedTags) }
            .makeServiceCall { request: AwsRequest?, client: ProxyClient<B2BiClient>? -> null as AwsResponse? }
            .progress()
    }
